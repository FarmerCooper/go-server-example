...
func (x *ListTodosRequest) GetPriority() int64 {
...
func (x *CreateTodoRequest) GetPriority() int64 {
	if x != nil {
		return x.Priority
	}
	return 0
...
func (x *UpdateTodoRequest) GetPriority() int64 {
	if x != nil && x.Priority != nil {
		return *x.Priority
	}
	return 0
...
func (x *DeleteTodoResponse) Reset() {
	*x = DeleteTodoResponse{}
	mi := &file_api_todo_v1_todo_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteTodoResponse) Descriptor() ([]byte, []int) {
	return file_api_todo_v1_todo_proto_rawDescGZIP(), []int{7}
}
...
const file_api_todo_v1_todo_proto_rawDesc = "" +
	"\n" +
	"\x16api/todo/v1/todo.proto\x12\atodo.v1\"\xa0\x01\n" +
	"\x04Todo\x12\x0e\n" +
	...
	"\bpriority\x18\x05 \x01(\x03R\bpriority\x12\x19\n" +
	"\bdue_date\x18\x06 \x01(\tR\adueDate\"q\n" +
	"\x10ListTodosRequest\x12!\n" +
	"\tcompleted\x18\x01 \x01(\bH\x00R\tcompleted\x88\x01\x01\x12\x1f\n" +
	"\bpriority\x18\x02 \x01(\x03H\x01R\bpriority\x88\x01\x01B\f\n" +
	"\n" +
	"_completedB\v\n" +
	"\t_priority\"8\n" +
	"\x11ListTodosResponse\x12#\n" +
	"\x05todos\x18\x01 \x03(\v2\r.todo.v1.TodoR\x05todos\"c\n" +
	...
	"\tcompleted\x18\x03 \x01(\bH\x01R\tcompleted\x88\x01\x01\x12\x1f\n" +
	"\bpriority\x18\x04 \x01(\x03H\x02R\bpriority\x88\x01\x01\x12\x1e\n" +
	"\bdue_date\x18\x05 \x01(\tH\x03R\adueDate\x88\x01\x01B\b\n" +
	"\x06_titleB\f\n" +
	"\n" +
	"_completedB\v\n" +
	"\t_priorityB\v\n" +
	...
	"\adeleted\x18\x01 \x01(\bR\adeleted2\xbd\x02\n" +
	"\vTodoService\x12B\n" +
	...
	"\n" +
	"DeleteTodo\x12\x1a.todo.v1.DeleteTodoRequest\x1a\x1b.todo.v1.DeleteTodoResponseB(Z&example.com/backend/api/todo/v1;todov1b\x06proto3"

var (
	file_api_todo_v1_todo_proto_rawDescOnce sync.Once
	file_api_todo_v1_todo_proto_rawDescData []byte
)

func file_api_todo_v1_todo_proto_rawDescGZIP() []byte {
	file_api_todo_v1_todo_proto_rawDescOnce.Do(func() {
		file_api_todo_v1_todo_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_todo_v1_todo_proto_rawDesc), len(file_api_todo_v1_todo_proto_rawDesc)))
	})
	return file_api_todo_v1_todo_proto_rawDescData
}

var file_api_todo_v1_todo_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_api_todo_v1_todo_proto_goTypes = []any{
...
var file_api_todo_v1_todo_proto_depIdxs = []int32{
	...
	4, // 3: todo.v1.TodoService.GetTodo:input_type -> todo.v1.GetTodoRequest
	5, // 4: todo.v1.TodoService.UpdateTodo:input_type -> todo.v1.UpdateTodoRequest
	6, // 5: todo.v1.TodoService.DeleteTodo:input_type -> todo.v1.DeleteTodoRequest
	2, // 6: todo.v1.TodoService.ListTodos:output_type -> todo.v1.ListTodosResponse
	0, // 7: todo.v1.TodoService.CreateTodo:output_type -> todo.v1.Todo
...
func file_api_todo_v1_todo_proto_init() {
	...
	file_api_todo_v1_todo_proto_msgTypes[1].OneofWrappers = []any{}
	file_api_todo_v1_todo_proto_msgTypes[5].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_todo_v1_todo_proto_rawDesc), len(file_api_todo_v1_todo_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
